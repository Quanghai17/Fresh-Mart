                                    ...
                                    <table class="table box table-bordered">
                                                ...
                                                <tr class="row_cart">
                                                    ...
                                                    <td>
                                                        <input style="width: 70px;" type="number"
                                                            ...
                                                            onChange="updateCart($(this));" class="item-qty"
                                                            name="qty-{{ $item->id }}"
                                                            value="{{ $item->qty }}"><span
                                        ...
                                        <tfoot>
                                            <tr style="background: #eaebec">
                                                <td colspan="7">
                                                    <div class="pull-left">
                                                        <button style="background-color: rgb(80, 153, 8)"
                                            ...
                                            <table class="table  table-bordered table-responsive">
                                                    ...
                                                    @if (sc_config('customer_lastname'))
                                                        <td
                                                            ...
                                                            @if ($errors->has('first_name'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('first_name') }}</span>
                                                            @endif
                                                        </td>
                                                        <td
                                                            ...
                                                            @if ($errors->has('last_name'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('last_name') }}</span>
                                                            @endif
                                                        </td>
                                                    @else
                                                        <td colspan="2"
                                                    ...
                                                    @if (sc_config('customer_phone'))
                                                        ...
                                                        <td
                                                            ...
                                                            <label for="phone" class="control-label"><i
                                                                ...
                                                                {{ trans('cart.phone') }}:</label>
                                                            <input name="phone" type="text"
                                                                placeholder="{{ trans('cart.phone') }}"
                                                                value="{{ old('phone') ? old('phone') : $shippingAddress['phone'] }}">
                                                            @if ($errors->has('phone'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('phone') }}</span>
                                                            @endif
                                                        </td>
                                                    @else
                                                        <td colspan="2"
                                                ...
                                                @if (sc_config('customer_country'))
                                                    <tr>
                                                        <td colspan="2"
                                                            ...
                                                            <label for="country" class="control-label"><i
                                                ...
                                                <tr>
                                                    @if (sc_config('customer_postcode'))
                                                        <td
                                                            ...
                                                            @if ($errors->has('postcode'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('postcode') }}</span>
                                                            @endif
                                                        </td>
                                                    @endif
                                                    ...
                                                    @if (sc_config('customer_company'))
                                                        <td
                                                            class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                                                            ...
                                                            @if ($errors->has('company'))
                                                                <span
                                                                    class="help-block">{{ $errors->first('company') }}</span>
                                                            @endif
                                                        </td>
                                                    @endif
                                                </tr>
                                                ...
                                                <tr>
                                                    <td
                                                        class="form-group {{ $errors->has('province') ? ' has-error' : '' }}">
                                                        <label for="province" class="control-label"><i
                                                                class="fa fa-list-ul"></i>Tỉnh/Thành
                                                            phố:</label>
                                                        {{-- <input name="province" type="text" placeholder="Tỉnh/Thành phố" value="{{ (old('province'))?old('province'):$shippingAddress['province']}}"> --}}
                                                    ...
                                                    <td
                                                        ...
                                                        <label for="district" class="control-label"><i
                                                                class="fa fa-list-ul"></i>
                                                            Quận/Huyện</label>
                                                        {{-- <input name="district" type="text" placeholder="Quận/Huyện" value="{{ (old('district'))?old('ward'):$shippingAddress['district']}}"> --}}
                                                        <select class="select2 card-select form-control" name="district"
                                                            id="district"></select>
                                                        @if ($errors->has('district'))
                                                            <span
                                                                class="help-block">{{ $errors->first('district') }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="form-group{{ $errors->has('ward') ? ' has-error' : '' }}">
                                                        <label for="ward" class="control-label"><i
                                                                class="fa fa-list-ul"></i>
                                                            Xã/Phường/Thị trấn</label>
                                                        {{-- <input name="ward" type="text" placeholder="Xã/Phường/Thị trấn" value="{{ (old('ward'))?old('ward'):$shippingAddress['ward']}}"> --}}
                                                        <select class="select2 card-select form-control" name="ward"
                                                            id="ward"></select>
                                                        @if ($errors->has('ward'))
                                                            <span
                                                                class="help-block">{{ $errors->first('ward') }}</span>
                                                        @endif
                                                    </td>
                                                    <td
                                                        ...
                                                        @if ($errors->has('address'))
                                                            <span
                                                                class="help-block">{{ $errors->first('address') }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div
                                                                ...
                                                                @if ($errors->has('totalMethod'))
                                                                    <span
                                                                        class="help-block">{{ $errors->first('totalMethod') }}</span>
                                                                @endif
                                                            </div>
                                            ...
                                            <div class="row" style="padding-bottom: 20px;">
                                                <div class="col-md-12 text-center">
                                                    <div class="pull-right">
                                                        <button style="background-color: rgb(94, 180, 7)"
                                                            class="btn btn-success" id="submit-order" type="button"
                    ...
                    jQuery.each(json, function(index, item) {
                        if (item.parent_code == code) {
                            ...
                            if (ward === item.name_with_type) {
                                opt = $('<option data-code="' + index + '" value="' + item.name_with_type +
                                    '" selected>' + item.name_with_type + '</option>');
                            } else {
                                opt = $('<option data-code="' + index + '" value="' + item.name_with_type +
                        ...
                        jQuery.each(json, function(index, item) {
                            if (item.parent_code == code) {
                                ...
                                if (district === item.name_with_type) {
                                    opt = $('<option data-code="' + index + '" value="' + item
                                        .name_with_type + '" selected>' + item.name_with_type +
                                        '</option>');
                                } else {
                                    opt = $('<option data-code="' + index + '" value="' + item
                    ...
                    $.getJSON('{{ asset('hcvn/tinh_tp.json') }}', function(json) {
                        jQuery.each(json, function(index, item) {
                            ...
                            if (province === item.name) {
                                opt = $('<option data-code="' + index + '" value="' + item.name +
            ...
            function get_province() {
                ...
                $.getJSON('{{ asset('hcvn/tinh_tp.json') }}', function(json) {
                    ...
                    jQuery.each(json, function(index, item) {
                        let opt;
                        if (province === item.name) {
                            opt = $('<option data-code="' + index + '" value="' + item.name + '" selected>' +
                                item.name + '</option>');
                        } else {
                            opt = $('<option data-code="' + index + '" value="' + item.name + '">' + item.name +
                                '</option>');
                        }
                        $('#province').append(opt);
                    });
