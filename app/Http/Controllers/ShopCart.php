...
//            'paymentMethod' => 'required',
        ...
        $messages = [
            ...
            'address.required' => trans('validation.required',['attribute'=> 'địa chỉ']),
            'ward.required' => trans('validation.required',['attribute'=> 'Xã/Phường']),
            'district.required' => trans('validation.required',['attribute'=> 'Quận/Huyện']),
            'province.required' => trans('validation.required',['attribute'=> 'Tỉnh/TP']),
...
//            'paymentMethod.required' => trans('cart.validation.paymentMethod_required'),
        ...
        session(['shippingMethod' => 'ShippingStandard']);
